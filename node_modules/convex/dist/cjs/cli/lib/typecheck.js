...
__export(typecheck_exports, {
  findTypeScriptCompilerPath: () => findTypeScriptCompilerPath,
...
function findTypeScriptCompilerPath(fs, typescriptCompiler) {
  switch (typescriptCompiler) {
    ...
    case "tsc": {
      const tscPaths = [
        ...
        import_path.default.join("node_modules", "@typescript", "native", "bin", "tsc"),
