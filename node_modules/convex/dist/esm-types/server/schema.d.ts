...
import { VFloat64, VId, VObject, VUnion, Validator } from "../values/validators.js";
/**
 ...
 * validator untouched.
 */
type WithSystemFieldValidators<TableName extends string, DocumentType extends Validator<any, any, any>> = DocumentType extends VObject<infer Type, infer Fields, any, any> ? VObject<Expand<IdField<TableName> & SystemFields & Type>, Expand<SystemFieldValidators<TableName> & Fields>> : DocumentType;
/**
 ...
 * @public
 */
export type DocValidator<TableName extends string, DocumentType extends Validator<any, any, any>> = DocumentType extends VUnion<any, infer Members, any, any> ? {
    [Index in keyof Members]: WithSystemFieldValidators<TableName, Members[Index]>;
} extends infer NewMembers extends Validator<any, "required", any>[] ? VUnion<WithSystemFieldValidators<TableName, Members[number]>["type"], NewMembers> : never : WithSystemFieldValidators<TableName, DocumentType>;
/**
 ...
 * @public
 */
export declare function docValidator<TableName extends string, Table extends TableDefinition<any, any, any, any>>(tableName: TableName, table: Table): DocValidator<TableName, Table["validator"]>;
/**
...
export declare class SchemaDefinition<Schema extends GenericSchema, StrictTableTypes extends boolean> {
     ...
     */
    doc<TableName extends keyof Schema & string>(tableName: TableName): DocValidator<TableName, Schema[TableName]["validator"]>;
    /**
