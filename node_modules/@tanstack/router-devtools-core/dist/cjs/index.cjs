	...
	mount(el) {
		...
		const dispose = require_context.render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = require_context.lazy(() => Promise.resolve().then(() => require("../FloatingTanStackRouterDevtools-B6BzrPyq.cjs")));
	...
	mount(el) {
		...
		const dispose = require_context.render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = require_context.lazy(() => Promise.resolve().then(() => require("../BaseTanStackRouterDevtoolsPanel-CDq3ZkLG.cjs")));
