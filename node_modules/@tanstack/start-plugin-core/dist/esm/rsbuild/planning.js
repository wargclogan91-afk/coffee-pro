...
function createPublicAssetDistPath(root) {
	return {
		root,
...
function createClientAssetDistPath(root) {
	return {
		...
		environments: {
			...
			...opts.serverFnProviderEnv !== RSBUILD_ENVIRONMENT_NAMES.server && !opts.rsc ? { [opts.serverFnProviderEnv]: mergeRsbuildConfig({
				...
				output: {
					target: "node",
					...opts.dev ? { module: false } : {},
					distPath: createPublicAssetDistPath(`${opts.serverOutputDirectory}/${opts.serverFnProviderEnv}`),
					assetPrefix: opts.publicBase
				},
				resolve: { alias }
